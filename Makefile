...
aur: ## Install arch linux AUR packages using yay
	yay -S duckdb-bin downgrade git-secrets firebase-tools-bin limbo-bin pscale-cli rgxg slack-desktop trdsql-bin tree-sitter-rust turso-cli-bin volta-bin zoom
