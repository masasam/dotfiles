...
PACKAGES	+= bash-completion mathjax expect obs-studio cscope postgresql-libs pdfgrep gnu-netcat cmatrix 
...
PACKAGES	+= guetzli fabric python-language-server detox usleep libvterm bind asunder lame git-lfs hex
...
FLUTTER_URL	:= https://storage.googleapis.com/flutter_infra/releases/stable/linux/flutter_linux_2.0.2-stable.tar.xz
