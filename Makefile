...
aur: ## Install arch linux AUR packages using yay
	yay -S antigravity-bin asunder downgrade firebase-tools-bin geeqie git-secrets pscale-cli rgxg slack-desktop turso-bin vscode-langservers-extracted zoom
