...
aur: ## Install arch linux AUR packages using yay
	yay -S bun-bin duckdb-bin downgrade git-secrets firebase-tools-bin limbo-bin pscale-cli rgxg slack-desktop trdsql-bin tree-sitter-rust turso-cli-bin volta-bin zoom
...
nextinstall: mycli pgcli pnpminstall rubygem rbenv rustinstall postgresql zeal gcloud awsv2 eralchemy gh
