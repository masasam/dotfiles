...
PACKAGES	+= guetzli fabric python-language-server detox
...
FLUTTER_URL	:= https://storage.googleapis.com/flutter_infra/releases/stable/linux/flutter_linux_v1.9.1+hotfix.6-stable.tar.xz
