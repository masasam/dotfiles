...
PACKAGES	+= gron typescript-language-server rye dateutils time xsv rust git-delta gruff zellij
...
allinstall: dconfsetting rclone gnupg ssh install init keyring urxvt xterm termite yay tlp pipewire-pulse ttf-cica dnsmasq goinstall ibusmozc neomutt docker lvfs toggle aur beekeeper kind gtk-theme chrome
