...
PACKAGES	+= imagemagick lynx the_silver_searcher cifs-utils elinks flameshot
...
PACKAGES	+= diffoscope dust rbw eza sslscan abiword pyright miniserve fdupes mold
PACKAGES	+= gron typescript-language-server dateutils time xsv rust rust-analyzer
