...
PACKAGES	+= zsh-syntax-highlighting npm yq ansible parallel alsa-utils geckodriver
...
PACKAGES	+= jhead peek ncdu gnome-screenshot sshfs fping syncthing terraform bat
PACKAGES	+= ripgrep stunnel vimiv adapta-gtk-theme gnome-tweaks firejail opencv
PACKAGES	+= smartmontools gnome-logs wireshark-cli wl-clipboard lsof watchexec
...
PACKAGES	+= noto-fonts-extra lazygit yazi imv ttf-font-awesome
...
allinstall: dconfsetting rclone gnupg ssh install init keyring mise ghostty alacritty wezterm tlp pipewire-pulse ttf-cica hyprland dnsmasq goinstall fcitx-mozc neomutt lvfs aur beekeeper kind gtk-theme chrome pipinstall ccls gh
