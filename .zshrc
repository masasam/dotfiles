...
alias caskupdate="cd ${HOME}/Dropbox/emacs/cask;    rm -fr `ls -rt | head -n 1`;    tar cfz ${HOME}/Dropbox/emacs/cask/`date '+%Y%m%d%H%M%S'`.tar.gz -C ${HOME}/.emacs.d .cask;   cd ${HOME}/.emacs.d/;   cask upgrade;   cask update;    cd -"
