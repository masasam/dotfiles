...
alias backupdropbox='time rclone sync ${HOME}/backup dropbox:backup'
alias backupdrive='time rclone sync ${HOME}/backup drive:backup'
alias backupcloud='backupdropbox; backupdrive'
