...
alias backupdropbox='rclone sync ${HOME}/backup dropbox:backup'
alias backupdrive='rclone sync ${HOME}/backup drive:backup'
alias backupcloud='time backupdropbox; time backupdrive'
