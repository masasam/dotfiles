...
alias backup2drive='rclone sync ${HOME}/backup drive:backup'
alias backup2dropbox='rclone sync ${HOME}/backup dropbox:backup'
alias backup2box='rclone sync ${HOME}/backup box:backup'
alias zshbackup='rm -rf ${HOME}/backup/zsh/backup/`ls -rt ${HOME}/backup/zsh/backup | head -n 1`; tar cfz ${HOME}/backup/zsh/backup/`date '+%Y%m%d%H%M%S'`.tar.gz -C ${HOME}/backup/zsh/ .zsh_history; rclone sync ${HOME}/backup/zsh googledrive:zshbackup'
