...
alias yaykeep3='find "${HOME}/.cache/yay" -maxdepth 1 -mindepth 1 -type d -print0 | xargs -0 --max-lines=1 paccache --remove --keep 3 --cachedir'
...
alias pipupdate='pip list --user | cut -d" " -f 1 | tail -n +3 | xargs pip install -U --user  --use-feature=2020-resolver; pip install --user python-language-server --use-feature=2020-resolver'
alias archupdate='yay -Syu; paccache -r; paccache -ruk0; yaykeep3'
