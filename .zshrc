...
alias dropbox='rclone sync ${HOME}/backup dropbox:backup'
alias googledrive='rclone sync ${HOME}/backup drive:backup'
alias backupcloud='time dropbox; time googledrive'
