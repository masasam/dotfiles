...
USER ${USERNAME}
WORKDIR /tmp
RUN wget https://github.com/Jguer/yay/releases/download/v12.0.1/yay_12.0.1_x86_64.tar.gz &&\
	tar xzvf yay_12.0.1_x86_64.tar.gz
USER root
RUN cp /tmp/yay_12.0.1_x86_64/yay /usr/bin/yay
USER ${USERNAME}
WORKDIR ${REPOSITORY}
