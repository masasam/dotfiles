...
USER ${USERNAME}
WORKDIR /tmp
RUN wget https://github.com/Jguer/yay/releases/download/v11.1.1/yay_11.1.1_x86_64.tar.gz &&\
	tar xzvf yay_11.1.1_x86_64.tar.gz
USER root
RUN cp /tmp/yay_11.1.1_x86_64/yay /usr/bin/yay
USER ${USERNAME}
WORKDIR ${REPOSITORY}
