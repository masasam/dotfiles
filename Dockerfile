...
USER ${USERNAME}
WORKDIR /tmp
RUN wget https://github.com/Jguer/yay/releases/download/v10.0.1/yay_10.0.1_x86_64.tar.gz &&\
	tar xzvf yay_10.0.1_x86_64.tar.gz
USER root
RUN cp /tmp/yay_10.0.1_x86_64/yay /usr/bin/yay
USER ${USERNAME}
WORKDIR ${REPOSITORY}
