...
hl.bind(mainMod .. " + Control_L + 1", hl.dsp.exec_cmd("~/.config/hypr/scripts/ctl-alt-1"))
hl.bind(mainMod .. " + Control_L + 2", hl.dsp.exec_cmd("~/.config/hypr/scripts/ctl-alt-2"))
hl.bind(mainMod .. " + Control_L + 3", hl.dsp.exec_cmd("~/.config/hypr/scripts/ctl-alt-3"))
hl.bind(mainMod .. " + Control_L + 4", hl.dsp.exec_cmd("~/.config/hypr/scripts/ctl-alt-4"))
hl.bind(mainMod .. " + Control_L + 5", hl.dsp.exec_cmd("~/.config/hypr/scripts/ctl-alt-5"))
hl.bind(mainMod .. " + Control_L + 6", hl.dsp.exec_cmd("~/.config/hypr/scripts/ctl-alt-6"))
hl.bind(mainMod .. " + Control_L + 7", hl.dsp.exec_cmd("~/.config/hypr/scripts/ctl-alt-7"))
hl.bind(mainMod .. " + Control_L + 8", hl.dsp.exec_cmd("~/.config/hypr/scripts/ctl-alt-8"))
hl.bind(mainMod .. " + Control_L + 9", hl.dsp.exec_cmd("~/.config/hypr/scripts/ctl-alt-9"))
...
hl.bind(mainMod .. " + Shift_L + Return", hl.dsp.window.move({ workspace = "special:magic" }))
